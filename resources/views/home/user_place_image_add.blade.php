                ...
                <div class="col-lg-10 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form role="form" action="{{route('user_image_store',['place_id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                                @csrf
                    ...
                    <table class="table table-bordered ">
                        ...
                        @foreach( $images as $rs)
                            ...
                            <tr class="table-info">
                                ...
                                <td><a href="{{route('user_image_delete',['id'=>$rs->id,'place_id'=>$data->id])}}" on onclick="return confirm('Eminmisiniz')"><img src="{{asset('assets/admin/images/file-icons/yeni')}}/delete.png"></a> </td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
