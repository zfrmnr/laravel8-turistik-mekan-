                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link active " id="payment-nav" data-toggle="pill" href="#payment-tab" role="tab"><i class="fa fa-heart"></i>Fav Place</a>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        @foreach($datalist as $rs)
                                            ...
                                            <tr class="table-info">
                                                ...
                                                <td><a href="{{route('user_favcart_update',['id'=>$rs->place->id])}}" on onclick="return confirm('Eminmisiniz')"><img src="{{asset('assets/admin/images/file-icons/yeni')}}/edit.png" width="20"></a> </td>
                                                <td><a href="{{route('user_favcart_delete',['id'=>$rs->id])}}" on onclick="return confirm('Eminmisiniz')"> <img src="{{asset('assets/admin/images/file-icons/yeni')}}/delete.png" width="20"></a> </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
